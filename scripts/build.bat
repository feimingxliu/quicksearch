...
:: Build
set LDFLAGS="-w -s -X github.com/feimingxliu/quicksearch/pkg/about.Version=%VERSION% -X 'github.com/feimingxliu/quicksearch/pkg/about.BuildDate=%BUILD_DATE%' -X github.com/feimingxliu/quicksearch/pkg/about.CommitHash=%COMMIT_HASH%"
